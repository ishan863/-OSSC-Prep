...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-primary-50">
      <div className="container-app min-h-screen flex items-center justify-center py-8">
          ...
          >
            <div className="card max-w-md mx-auto lg:mx-0 lg:ml-auto">
              ...
              <div className="lg:hidden text-center mb-6">
                <div className="w-16 h-16 rounded-2xl gradient-bg flex items-center justify-center shadow-lg mx-auto mb-4">
                  <span className="text-white font-bold text-2xl">RI</span>
                </div>
                <h1 className="text-2xl font-bold text-secondary-800">OSSC Exam Prep</h1>
                <p className="text-secondary-500">Revenue Inspector Exam</p>
              </div>
